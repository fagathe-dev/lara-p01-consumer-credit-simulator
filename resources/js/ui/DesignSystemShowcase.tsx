      ...
      <ComponentGrid>
        ...
        <ComponentSection>
          ...
          <ExampleBlock>
            ...
            >
              <Badge variant="custom" bgColor="#E8D5F2" textColor="#5C3E67">
                VIP
              </Badge>
              <Badge variant="custom" bgColor="#FFE4E4" textColor="#8B0000">
                Urgent
              </Badge>
              <Badge variant="custom" bgColor="#E4F0FF" textColor="#003399">
                Premium
              </Badge>
            </div>
          </ExampleBlock>
        ...
        <ComponentSection>
          ...
          <Card variant="default">
            ...
            <Card.Body>This is a default card with border.</Card.Body>
          </Card>

          <Card variant="elevated">
            <Card.Header>Elevated Card</Card.Header>
            <Card.Body>This card has a subtle shadow for depth.</Card.Body>
            <Card.Footer>
              <Button variant="primary" size="sm">
                Action
              </Button>
          ...
          <ExampleBlock style={{ overflow: 'auto' }}>
            <Table
              ...
              data={tableData.map((row) => ({
                ...row,
                status: (
                  <Badge variant="status" status={row.status as any}>
                    {row.status}
                  </Badge>
                ),
              }))}
        ...
        <ComponentSection>
          ...
          <ExampleBlock>
            ...
            >
              ...
              <Field htmlFor="fc-tel" label="Téléphone" error="Numéro invalide">
                <Input id="fc-tel" aria-describedby="fc-tel-error" />
              </Field>
            </FormGroup>
          </ExampleBlock>
        </ComponentSection>
        ...
        <ComponentSection>
          ...
          <ExampleBlock>
            <ExampleLabel>SelectableCard (card variant)</ExampleLabel>
            <Grid columns={3} gap={3} collapseBelow="480px">
              <SelectableCard
                label="Auto"
                icon={<CarGlyph />}
          ...
          <ExampleBlock>
            <ExampleLabel>SelectableCardList (list variant)</ExampleLabel>
            <Stack gap={2}>
              <SelectableCardList
        ...
        <ComponentSection>
          ...
          <ExampleBlock>
            ...
            <Figure caption="Répartition des mensualités">
              <Image src={PLACEHOLDER_IMG} alt="Graphique" radius="md" />
            </Figure>
          </ExampleBlock>
        </ComponentSection>
              ...
              items={[
                {
                  ...
                  content: (
                    <Text tone="secondary">
                      Le Taux Annuel Effectif Global représente le coût total du
                      crédit.
                    </Text>
                  ),
                },
                {
                  ...
                  content: (
                    <Text tone="secondary">
                      Oui, sous conditions prévues au contrat.
                    </Text>
                  ),
                },
              ]}
